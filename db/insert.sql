...
\copy "grupo-nucleo"("Compromiso","Hito primer compromiso","Hito segundo compromiso","Hito tercer compromiso","Hito cuarto compromiso","Hito quinto compromiso","Hito sexto compromiso","Hito séptimo compromiso","Hito octavo compromiso","Hito noveno compromiso","Hito décimo compromiso","Fecha de registro","Indicador 2","Indicador 3 - entidad - grupo nucleo","Indicador 3 - contraparte - grupo nucleo","Indicador 3 - contraparte","Indicador 3 - entidad","Indicador 7","Indicador 9") from 'grupo_nucleo.csv' csv header

\copy "diccionario-grupo-nucleo"("Atributo","Descripción") from 'diccionario_grupo_nucleo.csv' csv header

\copy "info-general-compromisos"("Nombre_compromisos","Hitos","Tematica","Entidad","Contraparte","El_compromiso_es_prometedor_segun_el_IRM","Valores_OGP","Vinculacion_ODS","Fecha_inicio_hito","Fecha_finalizacion_hito","Nombre_contacto","Correo_contacto") from 'info_general_compromisos.csv' csv header
